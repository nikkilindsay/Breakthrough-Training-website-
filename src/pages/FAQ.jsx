...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Our Self-Paced CNA program allows you to start immediately after enrollment — start anytime! The Hybrid Program runs in cohorts starting every 4th Tuesday — the next class starts October 20, 2026. Check our Class Schedule page for upcoming dates.'
      },
      {
